...
/**
 * Servlet implementation class InsertTemperatureServlet
 */
@WebServlet("/InsertTemperatureServlet")
public class InsertTemperatureServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsertTemperatureServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		temperatureService.InsertTemperatureService(inputPack, returnPack);
