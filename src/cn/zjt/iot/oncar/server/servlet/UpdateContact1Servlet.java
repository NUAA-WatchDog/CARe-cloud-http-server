...
/**
 * Servlet implementation class UpdateContact1Servlet
 */
@WebServlet("/UpdateContact1Servlet")
public class UpdateContact1Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateContact1Servlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		userService.UpdateUser_EMERcontact_1_Service(inputPack, returnPack);
