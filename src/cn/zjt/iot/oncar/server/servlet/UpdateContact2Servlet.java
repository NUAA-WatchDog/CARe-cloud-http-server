...
/**
 * Servlet implementation class UpdateContact2Servlet
 */
@WebServlet("/UpdateContact2Servlet")
public class UpdateContact2Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateContact2Servlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		userService.UpdateUser_EMERcontact_2_Service(inputPack, returnPack);
