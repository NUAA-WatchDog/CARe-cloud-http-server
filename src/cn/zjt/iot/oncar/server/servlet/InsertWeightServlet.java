...
import cn.zjt.iot.oncar.server.service.WeightService;
import cn.zjt.iot.oncar.server.util.SecurityUtil;

/**
 * Servlet implementation class InsertWeightServlet
 */
@WebServlet("/InsertWeightServlet")
public class InsertWeightServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsertWeightServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		weightService.InsertWeightService(inputPack, returnPack);
