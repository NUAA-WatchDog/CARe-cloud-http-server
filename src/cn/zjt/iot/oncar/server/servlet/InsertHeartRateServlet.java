...
/**
 * Servlet implementation class InsertHeartRateServlet
 */
@WebServlet("/InsertHeartRateServlet")
public class InsertHeartRateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsertHeartRateServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		heartRateService.InsertHeartRateService(inputPack, returnPack);
